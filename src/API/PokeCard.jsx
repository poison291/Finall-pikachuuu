...
<div 
  onClick={handleScene}
 className= " w-80 bg-gray-800 hover:bg-gray-700 transition-all duration-300 ease-in-out hover:scale-110 h-auto rounded-2xl border-teal-600 border-2">
  {/* Header section */}
...
<div className="id">
<h1 className=" text-gray-900 mx-2 hover:bg-gray-300 bg-white px-4 rounded-2xl">#{id}</h1>
</div> 
  </div>
{/* Image Section */}
